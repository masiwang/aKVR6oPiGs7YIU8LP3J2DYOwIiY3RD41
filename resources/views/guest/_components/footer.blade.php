<div class="container-fluid p-0 mt-3 mt-md-4">
    <section  id="contact" class="p-3 pb-5" style="background-color: #353535; color: #888">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-8">
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item footer-link">
                            <img class="image-footer" src="http://dinasperdagangan.surakarta.go.id/wp-content/uploads/2018/11/dinas-perdagangan.png">
                        </li>
                        <li class="nav-item footer-link">
                            <a>
                                <span>
                ...
                <div class="col-12 col-md-4">
                    <h4 class="text-light">Link Terkait</h4>
                    <hr>
                    <ul class="nav flex-column">
                        <li class="nav-item footer-link">
    ...
    <section style="background-color: #222">
        <div class="text-light text-center py-4 px-3">
